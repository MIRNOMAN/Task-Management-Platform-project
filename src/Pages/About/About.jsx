        ...
        <div>
            <div className="hero min-h-screen ">
                <div className="hero-content flex-col lg:flex-row-reverse">
                    <Lottie className="h-[400px]" animationData={aboutImage} />
                    <div>
                        <h1 className="text-5xl font-bold text-[#3789bc]">About Us!</h1>
                        <p className="py-6 pr-10 text-white">Welcome to the Manage Hub, your go-to resource for effective organizational management. Explore insightful strategies, practical tips, and expert advice to enhance leadership skills and optimize team performance.</p>
